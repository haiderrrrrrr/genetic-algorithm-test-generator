...
![Seeded terminal run](assets/terminal-seeded-run.png)

![Non-seeded terminal run](assets/terminal-non-seeded-run.png)

![Local search terminal output](assets/terminal-local-search-run.png)

### Coverage Progress Graph

![Coverage progress graph](assets/coverage-progress-graph.png)

### Generated Test Cases CSV

![Generated CSV output](assets/generated-test-cases-csv.png)
